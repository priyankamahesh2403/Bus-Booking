...
public class Billing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Each Item rate");

        jLabel6.setText("Bill Amount");

        jTextField1.setText("txtBillNo");

        jTextField2.setText("txtName");

        jTextField3.setText("txtAdress");

        jTextField4.setText("txtItems");

        jTextField5.setEditable(false);
        jTextField5.setText("txtAmount");

        jTextField6.setText("txtRate");
    ...
    private void btnCalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalculateActionPerformed
        ...
        int items = Integer.parseInt(jTextField4.getText());
    double rate = Double.parseDouble(jTextField6.getText());

    double amount = items * rate;
